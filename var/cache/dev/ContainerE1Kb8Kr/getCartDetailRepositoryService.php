 ...
 */
class getCartDetailRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CartDetailRepository' shared autowired service.
     *
     * @return \App\Repository\CartDetailRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CartDetailRepository.php';

        return $container->privates['App\\Repository\\CartDetailRepository'] = new \App\Repository\CartDetailRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
